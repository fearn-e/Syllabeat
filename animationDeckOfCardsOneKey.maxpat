...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 330.60000000000008, 284.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 494.0, 207.0, 36.0, 22.0 ],
					"text" : "- 0.15"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 330.60000000000008, 242.0, 182.39999999999992, 22.0 ],
					"text" : "pack sym 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 187.399999999999977, 40.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 142.60000000000008, 284.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 142.60000000000008, 170.0, 63.799999999999898, 22.0 ],
					"text" : "zl.reg"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 142.60000000000008, 138.0, 100.699999999999932, 22.0 ],
					"text" : "t b f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 142.60000000000008, 242.0, 182.39999999999992, 22.0 ],
					"text" : "pack sym 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 187.399999999999977, 100.0, 187.200000000000045, 22.0 ],
					"text" : "unpack sym 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 306.0, 170.0, 81.0, 22.0 ],
					"text" : "scale 0. 1. -5. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 224.300000000000011, 170.0, 78.0, 22.0 ],
					"text" : "scale 0. 1. 0. 1."
				}
